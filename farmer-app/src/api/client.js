...
// Single API client. Attaches the Bearer access token; on 401 refreshes once
// (single-flight) then retries; on refresh failure triggers logout. Throws ApiError.
export function createApi({ baseUrl = API_URL, getAccess, getRefresh, onTokens, onLogout }) {
  let refreshing = null;
